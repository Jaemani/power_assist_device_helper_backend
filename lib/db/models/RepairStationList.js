...
const RepairStationListSchema = new mongoose.Schema({
  state: { type: String, required: true, unique: true }, // 도
  city:   { type: String, required: true, unique: true }, // 시
...
const RepairStationListModel = mongoose.models.repairStationList || mongoose.model('repairStationList', RepairStationSchema);
